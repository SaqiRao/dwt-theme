                                        ...
                                        <div class="row">
                                            ...
                                            <li class="navbar nav-item dropdown dropstart">
                                                <div class="button-container">
                                                   <button class="delete-single-chat btn-theme" data-delete="<?php echo esc_attr__( 'Are you sure you want to remove this?', 'exertio_theme' ); ?>"><?php echo esc_html__('Delete','exertio_theme')  ?></button>
                                                </div>
