...
function dwt_listing_themes_register_required_plugins()
{
    ...
    if (!is_plugin_active('js_composer/js_composer.php')) {
        $elementor_plugin = array(
            ...
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/elementor.3.11.2.zip'), // If set, overrides default API URL and points to an external URL.
    ...
    $plugins = array(
        ...
        array(
            'name' => esc_html__('SB Chat', 'dwt-listing'), // The plugin name.
            'slug' => 'sb-chat', // The plugin slug (typically the folder name).
            'source' => get_template_directory() . '/required-plugins/sb-chat.zip', // The plugin source.
            /* 'source' => $plugin_link, // The plugin source. */
            'required' => true, // If false, the plugin is only 'recommended' instead of required.
        ...
        array(
            ...
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.   
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/woocommerce.7.4.2.zip'
        ...
        array(
            ...
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.   
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/redux-framework.4.3.26.zip'
            ), // If set, overrides default API URL and points to an external URL.
            'is_callable' => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
        ),
        array(
            ...
            'force_activation' => false, // If true, plugin is activated upon theme activation and cannot be deactivated until theme switch.
            'force_deactivation' => false, // If true, plugin is deactivated upon theme switch, useful for theme-specific plugins.    
            'external_url' => esc_url('https://downloads.wordpress.org/plugin/contact-form-7.5.7.4.zip'), // If set, overrides default API URL and points to an external URL.
            'is_callable' => '', // If set, this callable will be be checked for availability to determine if a plugin is active.
        ),
        array(
